...
public class Controller implements ActionListener {
	...
	public void execute() {
		...
		/*
		 * list.insertToFinal1(2, 3); list.insertToFinal1(3, 5); list.insertToFinal1(5,
		 * 7);
		 * 
		 * list.showList1();
		 * 
		 * System.out.println("-------");
		 * 
		 * list.insertToFinal2(2, 3); list.insertToFinal2(3, 5); list.insertToFinal2(5,
		 * 7);
		 * 
		 * list.showList2();
		 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "Sumar":
			...
			if (CheckFormat.letterFormat(pow11, pow12, pow13, pow21, pow22, pow23, coef11, coef12, coef13, coef21,
					coef22, coef23)) {
				// JOptionPane.showMessageDialog(null, "Todo good");
				list.insertToFinal1(Integer.parseInt(coef11), Integer.parseInt(pow11));
				list.insertToFinal1(Integer.parseInt(coef12), Integer.parseInt(pow12));
				list.insertToFinal1(Integer.parseInt(coef13), Integer.parseInt(pow13));

				list.showList1();

				System.out.println("---------");
				list.insertToFinal2(Integer.parseInt(coef21), Integer.parseInt(pow21));
				list.insertToFinal2(Integer.parseInt(coef22), Integer.parseInt(pow22));
				list.insertToFinal2(Integer.parseInt(coef23), Integer.parseInt(pow23));
